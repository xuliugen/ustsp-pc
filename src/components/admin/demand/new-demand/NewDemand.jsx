      ...
      if (!err) {
        const regData = {
          ...
          projectResearchInfo: {
            ...
            city: values.city,
            uploadfileUrl: this.state.uploadFile.fileUrl ? this.state.uploadFile.fileUrl : null,
            uploadfileName: this.state.uploadFile.fileName ? this.state.uploadFile.fileName : null,
